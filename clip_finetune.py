...
def load_image_folder_text_descriptions(root_dir):
    ...
    for folder in folders:
        ...
        if os.path.isdir(folder_path):
            ...
            for image in images:
                ...
                list_txt.append(folder)  # Use folder name as text description
...
# Load images and corresponding folder names as text descriptions
list_image_path, list_txt = load_image_folder_text_descriptions(image_folder_path)

# Create a dataset using the modified data loading approach
